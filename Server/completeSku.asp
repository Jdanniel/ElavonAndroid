...
sql1 = ""
sql1=sql1+"SELECT "
sql1=sql1+"	ID_PRODUCTO "
sql1=sql1+"FROM BD_AR "
sql1=sql1+"WHERE ID_AR = " & id_ar & "; "

set rs1 = con1.executeQuery(sql1)	

if not rs1.eof then
	id_producto = rs1.fields("ID_PRODUCTO")
else
	id_producto = "0"
end if
...
con.startConnection(DB_INI)
	...
	sql ="SELECT MO_MODULO.SKU " &_ 
		 ...
		 "WHERE " &_
		 "	P_UNIDAD.ID_PRODUCTO = " & id_producto & " " &_
