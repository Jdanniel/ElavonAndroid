...
con.startConnection(DB_INI)
	...
	if not rs.eof then
		Do until rs.EOF
			response.write("<A><![CDATA[" & rs.fields("ID_UNIDAD") 	   	   & "]]></A>")
			response.write("<B><![CDATA[" 	 & descNegocio 	   				   & "]]></B>")		
			response.write("<C><![CDATA[" 	 & rs.fields("DESC_CLIENTE") 	   & "]]></C>")		
			response.write("<D><![CDATA[" 	 & rs.fields("DESC_MARCA")   	   & "]]></D>")
			response.write("<E><![CDATA[" 	 & rs.fields("DESC_MODELO")  	   & "]]></E>")
			response.write("<F><![CDATA[" 	 & rs.fields("NO_SERIE") 	 	   & "]]></F>") 	
			response.write("<G><![CDATA[" 	 & rs.fields("DESC_STATUS_UNIDAD") & "]]></G>")
