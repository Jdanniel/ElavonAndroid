			...
			Do until rsValidacion.EOF
				if rsValidacion.fields("ID_STATUS_AR")<>"8" and rsValidacion.fields("ID_STATUS_AR")<>"2" then
					...
					if failed = false then
						...
						sql = sql & " @ID_TIPO_ITEM_SOLICITUD_ALMACEN=1, "
						...
						sql = "SP_UPDATE_STATUS_AR @ID_AR = "&idAR&" ,@ID_STATUS_AR = 12 , @ID_USUARIO = "&idTecnico
						con.executeQuery(sql)
					
						response.write("<r res=""OK"" desc=""Se ha realizado el cambio de status exitosamente!"" val=""1""/>")
					else
